...
export class NewEventRegister{
    ...
    constructor(insertValuesInsufficientId: string[],memberIds:string[]){
        ...
        this.insertNewAndUpdateSeqEvent = new InsertNewAndUpdateSeqEvent(
            insertValuesInsufficientId
        )
    }
    ...
    run = async() => {
        return await this.insertNewAndUpdateSeqEvent.confirmIsNotExist()
