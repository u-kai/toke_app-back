...
export class SQLInfoMaker{
    ...
    makeInsertInfo = (insertKeys: string[],insertValues: string[],whereKeys:string[],whereValues:string[],whereOperators:WhereOperator[]):InsertInfo => {
        return {
            tableName:this.tableName,
    ...
    makeUpdateInfo = (updateKeys:string[],updateValues:string[],whereKeys:string[],whereValues:string[],whereOperators:WhereOperator[]):UpdateInfo => {
        return {
            tableName:this.tableName,
