...
const userId = '0';
const selectInfoMakerForSchedule = new SelectMakerForSchedule_1.SelectMakerForSchedule(userId);
...
it('test info infos sql', () => {
    expect(sqlForAttendanceRequestInfos).toBe("SELECT * FROM attendance_requests WHERE attendance_request_id = '1' OR attendance_request_id = '2'");
});
